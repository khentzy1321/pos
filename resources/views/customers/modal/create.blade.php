<div method="post">
    <div class="modal fade text-left" id="ModalCreatePro" role="dialog" aria-hidden="true">
                        ...
                        <div class="card-body">
                            <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <button class="btn btn-primary float-right mt-2" type="submit">Add Customer</button>
                            </form>
                        </div>
                    </div>
                </div>
